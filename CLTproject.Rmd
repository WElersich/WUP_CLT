...
There are two peaks very close together. The mean is `r mean(my1000$k9)`, and the standard deviation is `r  sd(my1000$k9)`
...
There is one peak. The mean is `r mean(my1000$k16)`, and the standard deviation is `r  sd(my1000$k16)`
...
There is one peak. The mean is `r mean(my1000$k25)`, and the standard deviation is `r  sd(my1000$k25)`
...
There is one peak. The mean is `r mean(my1000$k36)`, and the standard deviation is `r  sd(my1000$k36)`

Now we can confirm the central limit theorem by comparing the values of the means:

```{R}
print(paste( 'predicted Standard deviation for a sample size of 4, according to CLT:', sd(my1000$kkardashtemp)/sqrt(4)))
print(paste( 'Actual Standard deviation for a sample size of 4:', sd(my1000$k4)))
```
  
  
```{r}
print(paste( 'predicted Standard deviation for a sample size of 9, according to CLT:', sd(my1000$kkardashtemp)/sqrt(9)))
print(paste( 'Actual Standard deviation for a sample size of 9:', sd(my1000$k9)))
```
  
  
```{r}
print(paste( 'predicted Standard deviation for a sample size of 16, according to CLT:', sd(my1000$kkardashtemp)/sqrt(16)))
print(paste( 'Actual Standard deviation for a sample size of 16:', sd(my1000$k16)))
```
  
  
```{r}
print(paste( 'predicted Standard deviation for a sample size of 25, according to CLT:', sd(my1000$kkardashtemp)/sqrt(25)))
print(paste( 'Actual Standard deviation for a sample size of 25:', sd(my1000$k25)))
```
  
  
```{r}
print(paste( 'predicted Standard deviation for a sample size of 36, according to CLT:', sd(my1000$kkardashtemp)/sqrt(36)))
print(paste( 'Actual Standard deviation for a sample size of 36:', sd(my1000$k36)))
```
  
  
```{R}
print(paste("means, in order from N = 4 to N=36", mean(my1000$kkardashtemp), mean(my1000$k4), mean(my1000$k9), mean(my1000$k16),mean(my1000$k25), mean(my1000$k36)))
```
The standard deviations are close to what is predicted by the standard limit theorem. furthermore, all population means are close together. This confirms that the central limit theorem is accurate.